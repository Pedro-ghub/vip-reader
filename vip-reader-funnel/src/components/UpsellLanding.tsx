        ...
        <div className="relative container mx-auto px-4 py-16 text-center">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-foreground leading-tight">
              PERO AHORA PUEDES VIVIR <span className="bg-primary text-white px-3 py-1.5 rounded-md whitespace-nowrap inline-block">LA EXPERIENCIA COMPLETA</span>.
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <p className="text-xl md:text-2xl mb-8 text-muted-foreground">
              Entra al <span className="font-bold text-primary">Modo VIP de Lectoras</span> y desbloquea lo que las demás nunca verán:
            </p>
          ...
          <div className="max-w-md mx-auto mt-8">
            ...
            >
              ...
              <span className="text-center leading-tight sm:leading-relaxed break-words relative z-10">SÍ, QUIERO EL MODO VIP AHORA</span>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12 text-foreground">
            🦋 LO QUE RECIBES EN EL <span className="bg-primary text-white px-3 py-1.5 rounded-md">MODO VIP</span>
          </h3>
            ...
            {[
              {
                ...
                description: "lee historias inéditas antes que todas las demás",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <Badge className="bg-gradient-luxury text-accent-foreground px-8 py-3 text-lg font-bold shadow-luxury">
            🎁 EXCLUSIVO - Solo para Lectoras VIP
          </Badge>
        </div>
      </div>
          ...
          <Card className="p-8 bg-gradient-card border-2 border-primary/30 shadow-intense">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                El valor real del Modo VIP, con todas las historias, bonos exclusivos, club privado y acceso anticipado, sería de
                <span className="line-through text-destructive font-bold text-xl ml-2">R$312/año</span>.
              </p>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Puedes entrar al Modo VIP <span className="font-bold text-primary">hoy, y para siempre</span>, por solo:
              </p>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  >
                    ...
                    <span className="text-center">SÍ, QUIERO EL MODO VIP AHORA</span>
                  </div>
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-center text-xs sm:text-sm text-muted-foreground px-2">
                    Sin acceso a capítulos secretos, sin historias exclusivas y sin el club cerrado.
                  </p>
                </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <Card className="p-8 bg-gradient-card border border-accent/30">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Si entras al Modo VIP y no amas lo que encuentres adentro… solo pide el reembolso.
            </p>
          </Card>
        </div>
      </div>
      ...
      <footer className="border-t border-border py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-muted-foreground">
            © 2024 Secret Historys - Modo VIP. Todos los derechos reservados.
          </p>
        </div>
      </footer>
    </div>
